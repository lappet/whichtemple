...
// Each temple is addressable at /<qid>, e.g. /Q3523924; /map and /rate are
// the other views.
const qidFromUrl = () => location.pathname.match(/^\/(Q\d+)$/)?.[1];
const isMapRoute = location.pathname === "/map";
const isRateRoute = location.pathname === "/rate";
const isOtherRoute = isMapRoute || isRateRoute;
...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (isRateRoute) {
      document.title = "Rate — Which Temple?";
      return;
    }
  ...
  if (isRateRoute) {
    return <RatePage temples={temples} />;
  }
    ...
    <div className="page">
      <header className="masthead">
        ...
        <div className="masthead-side">
          ...
          <a className="masthead-map" href="/rate">
            Rate
          </a>
        </div>
      </header>
